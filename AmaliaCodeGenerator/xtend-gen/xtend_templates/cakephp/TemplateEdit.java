...
public class TemplateEdit {
  ...
  public TemplateEdit(final Project project) {
  ...
  public CharSequence template() {
    ...
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("<li><?= $this->Form->postLink(");
    _builder.newLine();
    _builder.append("\t                ");
    _builder.append("__(\'Delete\'),");
    _builder.newLine();
    _builder.append("\t                ");
    ...
    _builder.append("\t                ");
    _builder.append("[\'confirm\' => __(\'Are you sure you want to delete # {0}?\', $");
    ...
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("<legend><?= __(\'Edit ");
